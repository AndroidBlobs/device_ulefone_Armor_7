PRODUCT_PROPERTY_OVERRIDES +=  \
    ...
    mediatek.wlan.chip=CONSYS_MT6779 \
    mediatek.wlan.module.postfix=_consys_mt6779 \
    ...
    persist.st_nfc_gsma_support=0 \
    persist.sys.pri.led_mode=1 \
    ...
    persist.vendor.duraspeed.ml.support=1 \
    ...
    ro.build.display.id=X90T88C.GQU.Ulefone.EEA.HB.FHD.AYAZ.1210.V3.01 \
    ...
    ro.config.alarm_alert=Alarm_Lights_default.ogg \
    ro.config.notification2_sound=Bongo_default.ogg \
    ro.config.notification_sound=Bongo_default.ogg \
    ro.config.ringtone2=prize_ring_koushao_default.ogg \
    ro.config.ringtone=prize_ring_koushao_default.ogg \
    ...
    ro.pcba_oversea_customer=guanqun \
    ro.pri.ai.scene=1 \
    ro.pri.bangs.screen=0 \
    ro.pri.brand.watermark=1 \
    ro.pri.brandwatermark.default.value=on \
    ro.pri.change_volte_icon=1 \
    ro.pri.charging_sound=1 \
    ro.pri.charging_tips=1 \
    ro.pri.continuousshotnum.default.value=20 \
    ro.pri.continuousshotnum.on=1 \
    ...
    ro.pri.picturezoom.pictureize=12000x9024 \
    ...
    ro.pri_back_function_key=1 \
    ro.pri_battery_capacity=5500 \
    ro.pri_bg_power_saving_enable=1 \
    ro.pri_bluetooth=0 \
    ro.pri_board_network_type=GB/WB/TB/CB/LtB/LfB \
    ro.pri_brightness_mode=0 \
    ro.pri_browser_homepage=http://ulefone.com/?utm_source=UlefoneDevices&utm_medium=armor7 \
    ro.pri_browser_yahoo_bookmarks_support=1 \
    ro.pri_build_number=Armor_7_TF1_EEA_V01 \
    ro.pri_calendar_monday_sort=0 \
    ro.pri_cam_vfb=1 \
    ro.pri_camera_fn_facebeauty=1 \
    ro.pri_changed_wallpaper=1 \
    ro.pri_children_space=1 \
    ro.pri_cts=1 \
    ro.pri_custom_build_version=GQ3083TF1_KSX90T_Ulefone_EEA_20191210_V01 \
    ro.pri_customer=pcba-sea \
    ro.pri_customer_logo_icon=1 \
    ...
    ro.pri_default_value_show_battery_percent=1 \
    ...
    ro.pri_hide_pictures_number=1 \
    ro.pri_home_function_key=1 \
    ...
    ro.pri_led=1 \
    ro.pri_led_switch_support=1 \
    ro.pri_lock_baseband_version=MOLY.LR13.R1.MP.V18,MOLY.LR13.R1.MP.V18 \
    ro.pri_lock_kernel_version=2 \
    ro.pri_lockscreen_sounds=1 \
    ro.pri_long_camera_key=0 \
    ro.pri_mmsreceiver_wakeup=1 \
    ro.pri_mobile_data_def_on=0 \
    ro.pri_navba_style=1 \
    ro.pri_navbar_height=48 \
    ro.pri_notification_center=1 \
    ro.pri_number_min_match=7 \
    ro.pri_otg=1 \
    ro.pri_ownerinfo_maxlen=200 \
    ro.pri_power_function_key=1 \
    ...
    ro.pri_screen_off_timeout=30000 \
    ...
    ro.pri_show_googleteekey_state=1 \
    ...
    ro.pri_stream_voice_call=6 \
    ro.pri_tee=2 \
    ro.pri_time_12_24=24 \
    ro.pri_touch_sounds=0 \
    ro.pri_underwater_camera_mode=1 \
    ...
    ro.prisw.prize_dialer_support=1 \
    ro.prizesw.call.game.model=1 \
    ro.sf.hwrotation=0 \
    ...
    ro.vendor.camera3.raw_16_apply_LSC=1 \
    ...
    ro.vendor.mediatek.version.branch=alps-mp-p0.mp3 \
    ro.vendor.mediatek.version.release=alps-mp-p0.mp3-V2.78 \
    ...
    ro.vendor.mtk_nn.option=A,B,D,E,F \
